                    ...
                    if (res["status"] === 0) {
                        ...
                        for (let i = 0; i < poiArr.length; i++) {
                            outputRes["wxMarkerData"][i] = {
                                ...
                                uid: poiArr[i]["uid"],
                                distance: poiArr[i]["detail_info"].distance,
                                city: poiArr[i]["city"],
                                price: poiArr[i]["detail_info"].price,
                                overall_rating: poiArr[i]["detail_info"].overall_rating,
                                total: res["total"]
                            } 
                        }
    ...
    detail(param) {
      ...
      wx.request({
        ...
        success(data) {
          ...
          if (res["errorNo"] === 0) {
            successComment(res.comment.comment_list);
